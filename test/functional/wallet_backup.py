...
class WalletBackupTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(self.nodes[2].getbalance(), 1100000000)
        ...
        # 114 are mature, so the sum of all wallets should be 114 * 1100000000 = 125400000000.
        assert_equal(total, 125400000000)
