...
class ScantxoutsetTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress("xcQmb895Wa9ztBCnDsjj3RbX5WkRLbLSc5", 0.008) # (m/0'/0'/0')
        self.nodes[0].sendtoaddress("xawm2Mp5LbXywSDGXiQVsmVDn6mFJSpuwC", 0.016) # (m/0'/0'/1')
        self.nodes[0].sendtoaddress("xuEukCgsXhWwM3vDiv6TLcb7CtnaUPxGdi", 0.032) # (m/0'/0'/1500')
        self.nodes[0].sendtoaddress("xhZS1kiuxEqq5f1adCfrRb9EGoqGcxYb4W", 0.064) # (m/0'/0'/0)
        self.nodes[0].sendtoaddress("xeaxfcYJ1vNFmzLfPduiKcar6iXJU9Bzce", 0.128) # (m/0'/0'/1)
        self.nodes[0].sendtoaddress("xcnAnZ8xKLf8jLn3sCpRJgeRHHtBNpGy5q", 0.256) # (m/0'/0'/1500)
        self.nodes[0].sendtoaddress("xbGGqvuNMV9EbEaGrj1QUwR5iR8yACdDiX", 0.512) # (m/1/1/0')
        self.nodes[0].sendtoaddress("xXucQFT1qmJNfVzMNrtxT2jeTfLx5EpB7w", 1.024) # (m/1/1/1')
        self.nodes[0].sendtoaddress("xg2PC74XkFXST17MYBy7BvnBnF2LsteG1x", 2.048) # (m/1/1/1500')
        self.nodes[0].sendtoaddress("xknmPQdjKCaZ5DvmVG1QYfJkyRmA2a1nry", 4.096) # (m/1/1/0)
        self.nodes[0].sendtoaddress("xpwQX3mubsgVB2tnYm1zvtH8sgEkBADpwE", 8.192) # (m/1/1/1)
        self.nodes[0].sendtoaddress("xgXRSjnwsgX7Fb4k5REhYxq1inUDLQmk7Q", 16.384) # (m/1/1/1500)
