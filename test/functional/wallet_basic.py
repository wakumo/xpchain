...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(walletinfo['immature_balance'], 300000)
        ...
        assert_equal(self.nodes[0].getbalance(), 300000)
        assert_equal(self.nodes[1].getbalance(), 300000)
        assert_equal(self.nodes[2].getbalance(), 0)

        # Check getbalance with different arguments
        assert_equal(self.nodes[0].getbalance("*"), 300000)
        assert_equal(self.nodes[0].getbalance("*", 1), 300000)
        assert_equal(self.nodes[0].getbalance("*", 1, True), 300000)
        assert_equal(self.nodes[0].getbalance(minconf=1), 300000)
        ...
        assert_equal(txout['value'], 300000)
        ...
        assert_equal(self.nodes[0].getbalance(), 600000 - 21)
        ...
        assert_equal(self.nodes[2].getbalance(), 599994)
        ...
        self.sync_all([self.nodes[0:3]])
        node_2_bal = self.check_fee_amount(self.nodes[2].getbalance(), Decimal('499994'), fee_per_byte, self.get_vsize(self.nodes[2].getrawtransaction(txid)))
        ...
        usp = self.nodes[1].listunspent(query_options={'minimumAmount': '299980'})[0]
        inputs = [{"txid": usp['txid'], "vout": usp['vout']}]
        outputs = {self.nodes[1].getnewaddress(): 299980, self.nodes[0].getnewaddress(): 11.11}
