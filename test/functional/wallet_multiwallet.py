...
class MultiWalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(w5_info['immature_balance'], 1100000000)
        ...
        for wallet_name, wallet in zip(wallet_names, wallets):
            ...
            assert_equal(info['immature_balance'], 1100000000 if wallet is wallets[0] else 0)
        ...
        w1.generate(101)
        assert_equal(w1.getbalance(), 2200000000)
