...
([`valgrind.supp`](https://github.com/xpc-wg/xpchain/blob/master/contrib/valgrind.supp))
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:xpc-wg/xpchain.git
...
Commit [`bb81e173`](https://github.com/xpc-wg/xpchain/commit/bb81e173) is an example of a scripted-diff.
